    ...
    return (
      <MainLayout>
        <div className="min-h-screen flex flex-col items-center justify-center px-4">
          ...
          <p className="text-zest-muted mb-8 text-center">Looks like you haven't added anything yet</p>
  ...
  return (
    <MainLayout>
      ...
      <div className="sticky top-0 z-30 bg-zest-dark/95 backdrop-blur-xl border-b border-zest-muted/10 px-4 py-4 flex items-center gap-4">
        ...
        <button 
          onClick={clearCart}
          className="ml-auto text-sm text-zest-danger hover:underline"
        >
          Clear All
        </button>
      </div>
      ...
      <div className="lg:hidden fixed bottom-20 left-0 right-0 bg-zest-card border-t border-zest-muted/10 p-4">
        <div className="flex items-center justify-between mb-4">
          <span className="text-zest-muted">Total</span>
